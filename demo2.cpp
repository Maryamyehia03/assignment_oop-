...
//***************************************************************************************************************************
        case 11: {
            ...
            // open Shuffle image.cpp to see and run filter shufflecc
        ...
        case 12: {
            ...
            for (int i = 0; i < SIZE - 3; ++i) {
                for (int j = 0; j < SIZE - 3; ++j) {                                   // Blur Image
                    avg += image[i][j] + image[i + 1][j + 1] + image[i + 2][j + 2] + image[i + 3][j + 3] +
                           image[i + 4][j + 4] + image[i + 5][j + 5] + image[i + 6][j + 6];
                    image[i][j] = avg / 7;
                    avg = 0;
                }
            }
